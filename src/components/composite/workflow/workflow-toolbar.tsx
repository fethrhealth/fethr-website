    ...
    <div className="border-[#EEEFF1] border-b">
      <div className="flex items-center justify-between pt-2.5 pr-4 pb-[9px] pl-3">
        ...
        <div className="flex items-center gap-x-[5px]">
          {/* Editor button */}
          <div className={`flex items-center gap-x-1.5 py-[3px] pr-1.5 pl-[5px] cursor-pointer ${
          ...
          {/* Runs button */}
          <div className={`flex items-center border-[#EEEFF1] bg-[#FBFBFB] gap-x-1.5 rounded-lg border py-[3px] pr-[4px] pl-[5px] cursor-pointer ${
